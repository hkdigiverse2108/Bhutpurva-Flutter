...
class UpdateSecondaryDetails extends GetView<UpdateProfileController> {
  const UpdateSecondaryDetails({super.key});
        ...
        child: Column(
          children: [
            ...
            CommonTextFormField(
              ...
              dropdownItems: const ['Not Selected', 'Married', 'Unmarried'],
              dropdownValue: controller.maritalStatus.value,
            ...
            CommonTextFormField(
              ...
              dropdownValue: controller.bloodGroup.value,
              onDropdownChanged: (value) {
